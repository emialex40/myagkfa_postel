...
class RLHtmlFix
{
	public static function _($string)
	{
		...
		$string = self::protectPhpCode($string);
		...
		$string = self::unprotectPhpCode($string);
	...
	private static function protectPhpCode($string)
	{
	...
	private static function unprotectPhpCode($string)
	{
		require_once __DIR__ . '/protect.php';
