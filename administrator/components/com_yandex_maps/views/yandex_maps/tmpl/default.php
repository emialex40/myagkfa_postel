...
<div class="com_yandex_maps">
	...
	<div class="section" href="javascript:void()">
		...
		<div class="row-fluid">
			<div class="span4">Версия:</div><div class="span4"><strong><?php echo simplexml_load_string(file_get_contents(JPATH_COMPONENT_ADMINISTRATOR.'/manifest.xml'))->version?> LITE</strong></div>
		</div>
		<div class="row-fluid">
