        ...
        <div class="browseview browscompare_list">
            ...
            foreach ($this->products as $product) {
                ...
                if (!empty($this->products)) {
                    ...
                    $action .= '<div class="clear"></div>';
                    $action .= '<div class="remcompare"><a class="compare_del" title="удалить"  onclick="ZtVirtuemarter.compare.remove(' . $product->virtuemart_product_id . ');"><i class="fa fa-times"></i>remove</a></div>';
                    $action .= '</div>';
