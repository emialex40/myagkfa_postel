...
<div class="zt_news_wrap">
        ...
        <div id="zt-news-scroll-<?php echo $module->id; ?>" class="zt-category">
            <?php foreach ($items as $key => $item) : ?>
                <div class="item">
                    ...
                    <?php if ($showCreated): ?>
                        <span
                            class="created"><?php echo JHTML::_('date', $item->created, 'M d, Y'); ?>
                            <?php //echo $item->hits . JText::_('MOD_ZTNEWS_VIEWS'); ?>
                        </span>
                    <?php endif; ?>
                    <?php if ($showTitle): ?>
                        <h3>
	...
	<div class="btn-news">
		<a class="btn" href="%D1%81%D1%82%D0%B0%D1%82%D1%8C%D0%B8">Читать все статьи</a>
	</div>
</div>