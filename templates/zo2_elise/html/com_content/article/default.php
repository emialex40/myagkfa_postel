...
<style type="text/css">
	.lft-content {display: none}
	.main-content {padding-left: 0}
	.rgt-content {padding-right: 0}
</style>
<div class="item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Article">
    ...
    <div class="tagspopular">
			...
			<strong>Tags: </strong><?php echo $this->item->tagLayout->render($this->item->tags->itemTags); ?>

			<div class="share-links pull-right">
				<ul class="social-icons">
					<li class="text-share"><strong>Share:</strong> </li>
