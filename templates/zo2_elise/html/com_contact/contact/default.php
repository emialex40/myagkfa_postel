...
?>
<script>jQuery('.main-content').removeClass('col-md-9').addClass('col-md-12');</script>
...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Person">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7 form-left"> 
            <?php echo '<h3>' . JText::_('COM_CONTACT_EMAIL_FORM') . '</h3>';  ?>
            <?php  echo $this->loadTemplate('form');  ?>
        </div>
        <div class="col-xs-12 col-sm-5 padding-left-60 hidden-xs"> 
