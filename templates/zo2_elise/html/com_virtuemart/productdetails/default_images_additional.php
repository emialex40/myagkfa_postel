...
<div class="additional-images">
	<?php
	$start_image = 0; //VmConfig::get('add_img_main', 1) ? 0 : 1;
	for ($i = $start_image; $i < count($this->product->images); $i++) {
		...
		<div class="floatleft">
			...
			if(VmConfig::get('add_img_main', 1)) {
				...
				echo $image->displayMediaThumb("",true, 'class="cloud-zoom-gallery" rel="useZoom: \'zoom\', smallImage: \''. JUri::root().$image->file_url .' \' " ',true,$image->file_description);
			}
			?>
		</div>
	<?php
