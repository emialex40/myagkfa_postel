 ...
 * $Id: default_pricelistnarrow.php 105 2017-01-23 08:33:40Z abhishekdas $
 * --------------------------------------------------------------------------------------
*/
		...
		<?php endif; ?>
			...
			<tbody class="poopc-shipment-table">
				<tr>
					...
					<td class="col-total" align="right">
						<?php 
						    $this->currencyDisplay->createPriceDiv('salesPrice','', $tot_price = $this->cart->pricesUnformatted['salesPrice'],false);
			...
			<?php if($this->params->get('show_taxes_separately', 0) && VmConfig::get('show_tax') && !empty($this->cart->cartData['VatTax'])) : ?>
				<tbody class="proopc-bill-taxrules proopc-separate-tax">
