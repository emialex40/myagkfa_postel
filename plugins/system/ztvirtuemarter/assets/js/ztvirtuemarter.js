        ...
        var _ZtVirtuemarter = {
            ...
            buttonWishlist: function (id) {
                return '<div class="wishlist wishlists'+id+'">'
                    + '<a class="wishlist-label add-wishlist hasTooltip " title="Отложить товар" onclick="ZtVirtuemarter.wishlist.add('+id+');">'
            ...
            buttonCompare: function (id) {
                return '<div class="compare compare'+id+'">'
                    + '<a class="compare-label add-compare hasTooltip " title="Добавить к сравнению" onclick="ZtVirtuemarter.compare.add('+id+');">'
            ...
            buttonQuickView: function (id) {
                return '<div class="quickview quickview'+id+'">'
                    + '<a class="quickview-label add-quickview hasTooltip " title="Быстрый просмотр" onclick="ZtVirtuemarter.quickview.show('+id+');">'
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    if (json.totalrem < 1) {
                        ...
                        $('#mod_wishlists .vmproduct').html('<div class="not_text wishlists">Нет отложенных товаров.</div>');
                    }
                    _self.updateItemCount(json.totalrem);
                    $.fancybox.close();
                }
